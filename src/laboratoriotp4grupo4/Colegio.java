...
public class Colegio {
    ...
    public static void main(String[] args) {
        ...
        alum1.AgregarMateria(ingles1);
        alum1.AgregarMateria(matematicas);
        alum1.AgregarMateria(laboratorio1);
        
        alum2.AgregarMateria(ingles1);
        alum2.AgregarMateria(matematicas);
        alum2.AgregarMateria(laboratorio1);
        //volvemos a agregar a alumno 2 la materia laboratorio 1
        alum2.AgregarMateria(laboratorio1);
